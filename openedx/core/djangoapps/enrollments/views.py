...
from common.djangoapps.student.models import CourseEnrollment, CourseEnrollmentUserProfile, User
...
from openedx.core.djangoapps.enrollments.serializers import CourseEnrollmentsApiListSerializer, CourseEnrollmentUserProfileSerializer
